...
export class AuthService {
  ...
  async createApiKey(accountName: string): Promise<{ accountId: string; apiKey: string }> {
  ...
  async validateApiKey(plaintextApiKey: string): Promise<(ApiKey & { accountId: string }) | null> {
